 ...
 * @generated
 */
public class CreateSyncProjectItemProviderAdapterFactory extends CreateSyncProjectAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
	/**
	 ...
	 * @generated
	 */
	protected ChildCreationExtenderManager childCreationExtenderManager = new ChildCreationExtenderManager(CreateSyncProjectEditPlugin.INSTANCE, CreateSyncProjectPackage.eNS_URI);
	...
	@Override
	public void dispose() {
		if (createSyncProjectTaskItemProvider != null) createSyncProjectTaskItemProvider.dispose();
	}
				...
				newChildDescriptors.add
					(createChildParameter
						(BasePackage.Literals.ANNOTATION__CONTENTS,
						 CreateSyncProjectFactory.eINSTANCE.createCreateSyncProjectTask()));
