...
import org.eclipse.oomph.setup.createsyncproject.*;
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CreateSyncProjectPackage.CREATE_SYNC_PROJECT_TASK: {
				...
				if (result == null) result = caseSetupTask(createSyncProjectTask);
				if (result == null) result = caseModelElement(createSyncProjectTask);
