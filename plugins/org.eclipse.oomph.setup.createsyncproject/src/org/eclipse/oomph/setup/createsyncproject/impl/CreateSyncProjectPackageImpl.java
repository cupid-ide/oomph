...
public class CreateSyncProjectPackageImpl extends EPackageImpl implements CreateSyncProjectPackage {
	...
	public static CreateSyncProjectPackage init() {
		if (isInited) return (CreateSyncProjectPackage)EPackage.Registry.INSTANCE.getEPackage(CreateSyncProjectPackage.eNS_URI);

		// Obtain or create and register package
		CreateSyncProjectPackageImpl theCreateSyncProjectPackage = (CreateSyncProjectPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof CreateSyncProjectPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new CreateSyncProjectPackageImpl());
	...
	public void initializePackageContents() {
		...
		// Create resource
		createResource("https://raw.githubusercontent.com/cupid-ide/oomph/master/plugins/org.earthsystemmodeling.oomph.createsyncproject/model/CreateSyncProject.ecore");
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "schemaLocation", "https://raw.githubusercontent.com/cupid-ide/oomph/master/plugins/org.earthsystemmodeling.oomph.createsyncproject/model/CreateSyncProject.ecore"
		   });
	}
	...
	protected void createEnablementAnnotations() {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "variableName", "setup.createsyncproject.p2",
			 "repository", "file:/home/rocky/eclipse/cupiddev-v0-2/git/oomph/releng/org.earthsystemmodeling.oomph.releng.p2/target/repository",
			 "installableUnits", "org.earthsystemmodeling.oomph.createsyncproject.feature.group"
		   });
	}
	...
	protected void createLabelProviderAnnotations() {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "imageBaseURI", "http://git.eclipse.org/c/oomph/org.eclipse.oomph.git/plain/plugins/org.eclipse.oomph.setup.createsyncproject.edit/icons/full/obj16"
		   });
	}
